<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true" CodeFile="classic_room.aspx.cs" Inherits="Default4" %>
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="home.aspx">Home</a></span> <span class="mr-2"><a href="rooms.aspx">Room</a></span></p>
	            <h1 class="mb-4 bread">Classic Room</h1>
            </div>
          </div>
        </div>
      </div>
